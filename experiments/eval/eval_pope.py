...
dataset = "coco"    # coco aokvqa gqa
type = "random"     # random popular adversarial
parser.add_argument("--gt_files", type=str, default="./data/pope/"+dataset+"/"+dataset+"_pope_"+ type +".json")
parser.add_argument("--gen_files", type=str, default="./output/llava/pope/"+dataset+"/"+type+"/our/greedy/1_0.4_2_0.1_att_min_top_k_seed100.jsonl")
