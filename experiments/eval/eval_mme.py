...
parser.add_argument('--results_dir', default='./output/instructblip/mme/our/greedy/1_0.3_1.4_0.1_att_min_seed100', type=str)
...
class calculate_metrics:
    ...
    def process_result(self, results_dir, output_file):
        ...
        for eval_type, task_name_list in eval_type_dict.items():
            ...
            for task_name, score in task_score_dict.items():
                ...
                result.append({"task_name":task_name, "task_score":task_score, "acc": acc_score,
                               ...
                               "other": other_len, "total_socre":None})
...
if __name__ == "__main__":
    ...
    cal.process_result(results_dir, output_file)
